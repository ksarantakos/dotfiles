# Generated by Powerlevel10k configuration wizard on 2026-03-16 at 10:50 EDT.
...
# angled separators, round heads, blurred tails, 2 lines, solid, full frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND='#C0CAF5'
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_SHORTENED_FOREGROUND='#292E42'
  # Color of the anchor directory segments. Anchor segments are never shortened. The first
  # segment is always an anchor.
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND='#10131A'
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_BACKGROUND='#3B4261'
  typeset -g POWERLEVEL9K_VCS_MODIFIED_BACKGROUND='#565F89'
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_BACKGROUND='#414868'
  typeset -g POWERLEVEL9K_VCS_CONFLICTED_BACKGROUND='#DB4B6B'
  typeset -g POWERLEVEL9K_VCS_LOADING_BACKGROUND='#292E42'
  ...
  function my_git_formatter() {
    ...
    local       meta='%F{#A9B1D6}' # muted foreground
    local      clean='%F{#C0CAF5}' # soft foreground
    local   modified='%F{#C0CAF5}' # soft foreground
    local  untracked='%F{#C0CAF5}' # soft foreground
    local conflicted='%F{#F7768E}' # conflict foreground
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_FOREGROUND='#A9B1D6'
  ...
  typeset -g POWERLEVEL9K_STATUS_OK_PIPE_FOREGROUND='#A9B1D6'
  ...
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND='#8F9BBF'
  ...
  #######################[ direnv: direnv status (https://direnv.net/) ]########################
  # Direnv color.
  typeset -g POWERLEVEL9K_DIRENV_FOREGROUND='#9AA5CE'
